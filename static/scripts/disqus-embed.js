var DISQUS = function(a) {
    ...
    return b.define = function(c, d) {
        ...
        for (var e = c.split("."), f = e.shift(), g = b, h = (d || function() {
            ...
            g = g[f] ? g[f] : g[f] = {}, f = e.shift();
        for (var i in h)
            h.hasOwnProperty(i) && (!h.__overwrites__ && null !== g[i] && g.hasOwnProperty(i) ? b.logError && b.logError("Unsafe attempt to redefine existing module: " + i) : g[i] = h[i]);
        return g
    }, b.use = function(a) {
        return b.define(a)
    }, b.define("next"), b
...
DISQUS.define(function(a, b) {
    ...
    var a = "default", b = "ffbf1a08", c = {
        ...
        var h = c[e];
        if (!h)
            throw new Error("Unknown app: " + e);
        var i = d(h, document.location.protocol), j = DISQUS.extend({
            base: a,
            disqus_version: b
        }, f || {}), k = g ? "#" + encodeURIComponent(JSON.stringify(g)): "";
    ...
    var a = function(a) {
        ...
        off: function(a, b, d) {
            var e, f, h, i, j, k, l, m;
            if (!this._events ||!g(this, "off", a, [b, d]))
                return this;
            if (!a&&!b&&!d)
                ...
                if (a = i[j], h = this._events[a]) {
                    if (this._events[a] = e = [], b || d)
                        for (l = 0, m = h.length; m > l; l++)
                            f = h[l], (b && b !== f.callback && b !== f.callback._callback || d && d !== f.context) && e.push(f);
        ...
        if (f.test(c)) {
            for (var g = c.split(f), h = 0, i = g.length; i > h; h++)
    ...
    var c = a.document, d = {}, e = DISQUS.use("JSON"), f = DISQUS.isOwn, g = c.createElement("a"), h = {};
    h.getOffset = function(a, b) {
        b = b || c.documentElement;
        for (var d = a, e = 0, f = 0; d && d !== b;)
    ...
    var j = h.WindowBase = function(a) {
        a = a || {}, this.state = j.INIT, this.uid = a.uid || DISQUS.getUid(), this.origin = a.origin, this.host = h.getHost("*" !== this.origin ? this.origin : "http://disqus.com"), this.target = a.target, this.window = null, d[this.uid] = this, this.on("ready", function() {
            this.state = j.READY
    ...
    return DISQUS.extend(n.prototype, l.prototype), n.prototype.load = function() {
        ...
        var a = this.elem, d = DISQUS.isString(this.container) ? b(this.container): this.container;
    ...
    function f(a, b) {
        ...
        for (var g = 0; g < a.length; g++)
            for (var h = 0; h < b.length; h++)
                a[g] === b[h] && (d[g + 1][h + 1] = d[g][h] + 1, d[g + 1][h + 1] > c && (c = d[g + 1][h + 1]));
        return c
    }
    function g() {
        for (var a = t.getElementsByTagName("h1"), c = t.title, d = c.length, e = c, g = .6, h = 0; h < a.length; h++)
            !function(a) {
    ...
    var s = "//referrer.disqus.com/juggler", t = a.document, u = function() {
        var a, b, c = function() {
            return !1
        };
        if ("undefined" != typeof t.hidden)
            a = "hidden", b = "visibilitychange";
        else if ("undefined" != typeof t.mozHidden)
            a = "mozHidden", b = "mozvisibilitychange";
        else if ("undefined" != typeof t.msHidden)
            a = "msHidden", b = "msvisibilitychange";
        else {
            if ("undefined" == typeof t.webkitHidden)
                return {
                    isHidden: c,
                    listen: c,
                    stopListening: c
    ...
    "use strict";
    var b = DISQUS.isOwn, c = DISQUS.extend, d = DISQUS.use("next.host"), e = d.urls, f = document, g = f.documentElement, h = f.location.protocol, i = {
        ...
        var c = [], d = this;
        do 
            c.unshift(d), d = d.constructor.__super__;
        while (d);
        for (var e = 0, f = c.length; f > e; e++)
            d = c[e], d.events && this.on(d.events, this), d.onceEvents && this.once(d.onceEvents, this)
    };
    ...
    var l = k.extend({
        ...
        listenToScrollEvent: function(a) {
            ...
            if (c === g)
                return b.listenTo(DISQUS, "window.scroll", a), function() {
        ...
        events: {
            ...
            "frame:scrollTo": function(b, c) {
                if (c.elem && c.getOffset) {
                    var d = this.getScrollContainer(), e = c.getOffset(d), f = "window" === b.relative ? b.top: e.top + b.top, h = this.getViewportCoords();
    ...
    "use strict";
    var b = DISQUS.next.host, c = b.utils, d = b.app.WindowedApp, e = d.extend({
        name: "profile",
        events: {
            beforeInit: function() {
                var a = this.settings;
    ...
    "use strict";
    var b = DISQUS.next.host, c = b.utils, d = b.app.WindowedApp, e = /^calc\((.+)\)$/, f = d.extend({
        name: "home",
        events: {
            "frame:close": function(b, c) {
                c.hide(), a.focus()
            ...
            "frame:openReady": function() {
                ...
                var a = this.getBodyOverflow(), b = document.body.style.marginRight;
        ...
        setBodyStyles: function(a) {
            for (var b in a)
                document.body.style[b] = a[b]
        },
        getBodyOverflow: function() {
            return document.body.style.overflow
        },
        getSecureOrigin: function() {
            var a = b.urls.ensureHttpBasedProtocol("https://disqus.com/home/", "https:"), c = a.split("/"), d = c[0], e = c[2];
            return d + "//" + e
        },
        getFrameSettings: function(a) {
        ...
        getUrl: function() {
            var a = this.settings.path || "", c = this.settings.language, d = {
    ...
    var b = a.document, c = ".disqus-loader{animation:disqus-embed-spinner .7s infinite linear;-webkit-animation:disqus-embed-spinner .7s infinite linear}@keyframes disqus-embed-spinner{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@-webkit-keyframes disqus-embed-spinner{0%{-webkit-transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg)}}", d = "//a.disquscdn.com/next/assets/img/loader-bg.aab79aac7146e054d372b00794ea3b14.png", e = DISQUS.next.host, f = e.utils, g = e.app.ThreadBoundApp, h = g.extend({
        ...
        preloadHome: function() {
            var a = this.home = e.home.preload(this.getHomeData("preload"));
            this.listenToOnce(a, "frame:ready", function() {
        ...
        getHomeData: function(a) {
            ...
            return this.settings.apiKey && this.settings.remoteAuthS3 && (b.sso = {
                apiKey: this.settings.apiKey,
                remoteAuthS3: this.settings.remoteAuthS3
            }), b
        },
        showOnboard: function(a) {
            var b = this.settings, c = e.onboard.Onboard({
                windowName: a.windowName,
                language: b.language,
                forum: b.forum,
                forumId: a.forumId,
    ...
    var b, c = DISQUS.use("next.host.loader"), d = DISQUS.use("next.host"), e = new d.config.HostConfig(a), f=!1, g = function() {
        ...
        if (b.getElementsByClassName) {
            if ("complete" !== b.readyState)
                return DISQUS.addEvent(a, "load", g);
